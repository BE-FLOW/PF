...
경과 기록, 참여코드 기반 GPT 검토용 초안 생성까지 구현되어 있다. Apple 심사와
Google 공개 트랙 제출 전에는 계정 삭제 요청 흐름과 내부 테스트 빌드를 한 번 더
확인한다.
...
- 계정 삭제 요청 경로를 개인정보 처리방침 또는 앱 내부에 제공한다.
...
3. 장기 30일·60일·90일 경과 또는 GPT 피드백 수집 구현
4. 계정 삭제 요청 흐름을 앱 안에 노출
