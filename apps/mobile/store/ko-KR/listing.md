...
정리한 수의사 검토용 초안이며, 수의사의 확인을 대신하지 않습니다. 모든 로그인
사용자에게 동일한 무료 월간 제공량이 적용되며 코드나 결제로 기능을 열지 않습니다.
...
제공합니다. 로그인 후 이메일, 닉네임, 국내 휴대전화번호를 필수로
받고, 전화번호는 본인 인증이나 광고·마케팅이 아니라 서비스 안내와 테스트 관련
연락에만 사용합니다. AI 병원 요약은 모든 로그인 사용자에게 동일한 무료 월간
제공량을 적용하는 수의사 검토용 초안이며, 전문가 확인 정보로 표시하지 않습니다.
앱은 디지털 기능을 판매하지 않으며 코드, 구독, 외부 결제 또는 계정 등급으로 AI
기능을 열지 않습니다.
